...
cd $dir0/Analysis/ATAC_seq/Union/R_output_Common_0/Clusters
for i in `ls *20-clusters.bed`; do
  ...
  #findMotifsGenome.pl ${filename}_5_column.bed mm10 ${filename}_motif/ -nomotif -size 200 -p 35 -bg ${filename}_peaks_subtract_5_column.bed -keepFiles	##Does motif analysis at unique ATAC seq peaks
done
