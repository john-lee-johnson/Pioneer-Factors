...
sed -i -e 's/\[ChIP-Seq\]/ChIP-Seq/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM523222: DP-Gata3 ChIP-seq/GSM523222,DP,Mus musculus,ChIP_seq,Gata3,Zhao,Illumina,Single,Rep_1/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM523221: DN-Gata3 ChIP-seq/GSM523221,DN,Mus musculus,ChIP_seq,Gata3,Zhao,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM742021: DP-Gata3-replicate ChIP-Seq/GSM742021,DP,Mus musculus,ChIP_seq,Gata3,Zhao,Illumina,Single,Rep_2/g' $infodir/sample_files_${des}.txt
...
cp $paralleldir/macs_parallel_${des}.txt $paralleldir/macs_parallel_atac_${des}.txt
...
echo "Notes: Gata3 in DN and DP. Datasets are good quality, but no Input DNA provided" >> $logdir/download_log_${des}.txt 
echo "-------------------------------------------------------------------------------------------------------------------------------------" >> $logdir/download_log_${des}.txt  
