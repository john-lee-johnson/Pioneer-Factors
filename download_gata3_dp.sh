...
#Set genome build, currently only mm10 is supported
genome=mm10
...
sed -i -e '/H3/d' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774302: ThyDP_Input_sample1/GSM774302,DP,Mus musculus,ChIP_seq,Input,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774297: ThyDP_GATA3_sample1/GSM774297,DP,Mus musculus,ChIP_seq,Gata3,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774294: ThyDP_PU.1_sample1/GSM774294,DP,Mus musculus,ChIP_seq,PU.1,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774301: ThyDN3_Input_sample1/GSM774301,DN3,Mus musculus,ChIP_seq,Input,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774300: FLDN2b_Input_sample1/GSM774300,FLDN2b,Mus musculus,ChIP_seq,Input,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774299: FLDN2a_Input_sample1/GSM774299,FLDN2a,Mus musculus,ChIP_seq,Input,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774298: FLDN1_Input_sample1/GSM774298,FLDN1,Mus musculus,ChIP_seq,Input,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774296: FLDN2b_GATA3_sample1/GSM774296,FLDN2b,Mus musculus,ChIP_seq,Gata3,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774295: FLDN1_GATA3_sample1/GSM774295,FLDN1,Mus musculus,ChIP_seq,Gata3,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774293: FLDN2b_PU.1_sample1/GSM774293,FLDN2b,Mus musculus,ChIP_seq,PU.1,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774292: FLDN2a_PU.1_sample1/GSM774292,FLDN2a,Mus musculus,ChIP_seq,PU.1,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM774291: FLDN1_PU.1_sample1/GSM774291,FLDN1,Mus musculus,ChIP_seq,PU.1,Rothenberg,Illumina,Single,Rep_0/g' $infodir/sample_files_${des}.txt
...
mkdir -p tmp
echo "bowtie -p 38 -S -C mm10_colorspace -f ${srr}_F3.csfasta -Q ${srr}_F3_QV.qual ${srr}.sam" >> $logdir/download_log_${des}.txt
...
cp $paralleldir/macs_parallel_${des}.txt $paralleldir/macs_parallel_chip_${des}.txt
sed -i -e 's,DP_ChIP_seq_Gata3_Rothenberg_mm10_GSM774297 65,DP_ChIP_seq_Gata3_Rothenberg_mm10_GSM774297 65 /mnt/data1/John/Pioneer_Factors/Data/ChIP_seq/DP/Input/Rothenberg/DP_ChIP_seq_Input_Rothenberg_mm10_GSM774302.bam,g' $paralleldir/macs_parallel_chip_${des}.txt
sed -i -e 's,FLDN2b_ChIP_seq_Gata3_Rothenberg_mm10_GSM774296 93,FLDN2b_ChIP_seq_Gata3_Rothenberg_mm10_GSM774296 93 /mnt/data1/John/Pioneer_Factors/Data/ChIP_seq/FLDN2b/Input/Rothenberg/FLDN2b_ChIP_seq_Input_Rothenberg_mm10_GSM774300.bam,g' $paralleldir/macs_parallel_chip_${des}.txt
sed -i -e 's,FLDN2b_ChIP_seq_PU.1_Rothenberg_mm10_GSM774293 67,FLDN2b_ChIP_seq_PU.1_Rothenberg_mm10_GSM774293 67 /mnt/data1/John/Pioneer_Factors/Data/ChIP_seq/FLDN2b/Input/Rothenberg/FLDN2b_ChIP_seq_Input_Rothenberg_mm10_GSM774300.bam,g' $paralleldir/macs_parallel_chip_${des}.txt
sed -i -e 's,FLDN1_ChIP_seq_Gata3_Rothenberg_mm10_GSM774295 72,FLDN1_ChIP_seq_Gata3_Rothenberg_mm10_GSM774295 72 /mnt/data1/John/Pioneer_Factors/Data/ChIP_seq/FLDN1/Input/Rothenberg/FLDN1_ChIP_seq_Input_Rothenberg_mm10_GSM774298.bam,g' $paralleldir/macs_parallel_chip_${des}.txt
sed -i -e 's,DP_ChIP_seq_PU.1_Rothenberg_mm10_GSM774294 210,DP_ChIP_seq_PU.1_Rothenberg_mm10_GSM774294 210 /mnt/data1/John/Pioneer_Factors/Data/ChIP_seq/DP/Input/Rothenberg/DP_ChIP_seq_Input_Rothenberg_mm10_GSM774302.bam,g' $paralleldir/macs_parallel_chip_${des}.txt
sed -i -e 's,FLDN2a_ChIP_seq_PU.1_Rothenberg_mm10_GSM774292 99,FLDN2a_ChIP_seq_PU.1_Rothenberg_mm10_GSM774292 99 /mnt/data1/John/Pioneer_Factors/Data/ChIP_seq/FLDN2a/Input/Rothenberg/FLDN2a_ChIP_seq_Input_Rothenberg_mm10_GSM774299.bam,g' $paralleldir/macs_parallel_chip_${des}.txt
sed -i -e 's,FLDN1_ChIP_seq_PU.1_Rothenberg_mm10_GSM774291 97,FLDN1_ChIP_seq_PU.1_Rothenberg_mm10_GSM774291 97 /mnt/data1/John/Pioneer_Factors/Data/ChIP_seq/FLDN1/Input/Rothenberg/FLDN1_ChIP_seq_Input_Rothenberg_mm10_GSM774298.bam,g' $paralleldir/macs_parallel_chip_${des}.txt
...
echo "Notes: Gata3 and PU.1 in DP. Gata3 and PU.1 in cultured DN cells. Low quality reads, 30% of total reads thrown out due to low quality, may not be the best representation." >> $logdir/download_log_${des}.txt 
echo "-------------------------------------------------------------------------------------------------------------------------------------" >> $logdir/download_log_${des}.txt  
