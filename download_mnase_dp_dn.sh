...
sed -i -e 's/GSM1359852: DP Mnase-Seq; Mus musculus; MNase-Seq/GSM1359852,DP,Mus musculus,MNase_seq,Cauchy,ABI,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's.GSM1359851: Rag2 -/- Mnase-Seq; Mus musculus; MNase-Seq.GSM1359851,DN,Mus musculus,MNase_seq,Cauchy,ABI,Single,Rep_0.g' $infodir/sample_files_${des}.txt

#sed -i -e 's/Input; Mus musculus; ChIP-Seq/Mus musculus; ChIP-Seq; Input/g' $infodir/sample_files_${des}.txt
#sed -i -e 's/Runx1; Mus musculus; ChIP-Seq/Mus musculus; ChIP-Seq; Runx1/g' $infodir/sample_files_${des}.txt
#sed -i -e 's/E47; Mus musculus; ChIP-Seq/Mus musculus; ChIP-Seq; E47/g' $infodir/sample_files_${des}.txt
...
sed -i -e 's, 156, 156 /mnt/data1/John/Pioneer_Factors/Data/ChIP_seq/DN/Input_Cauchy/DN_ChIP_seq_Input_Cauchy_mm10_GSM1360736.bam,g' $paralleldir/macs_parallel_chip_${des}.txt
sed -i -e 's, 142, 142 /mnt/data1/John/Pioneer_Factors/Data/ChIP_seq/DN/Input_Cauchy/DN_ChIP_seq_Input_Cauchy_mm10_GSM1360736.bam,g' $paralleldir/macs_parallel_chip_${des}.txt
...
echo "Notes: Notes: Low coverage per experiment (~60 million reads) so does not show clear nucleosome positioning." >> $logdir/download_log_${des}.txt 
echo "-------------------------------------------------------------------------------------------------------------------------------------" >> $logdir/download_log_${des}.txt  
