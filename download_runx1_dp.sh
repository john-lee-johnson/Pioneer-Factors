...
sed -i -e 's/GSM1095815: Runx1_ChIP; Mus musculus; ChIP-Seq/GSM1095815,DP,Mus musculus,ChIP_seq,Runx1,Bergon,ABI,Single,Rep_0/g' $infodir/sample_files_${des}.txt
sed -i -e 's/GSM1095814: Runx1_input; Mus musculus; ChIP-Seq/GSM1095814,DP,Mus musculus,ChIP_seq,Input,Bergon,ABI,Single,Rep_0/g' $infodir/sample_files_${des}.txt
...
sed -i -e 's, 78, 78 /mnt/data1/John/Pioneer_Factors/Data/ChIP_seq/DP/Input/Bergon/DP_ChIP_seq_Input_Bergon_mm10_GSM1095814.bam,g' $paralleldir/macs_parallel_chip_${des}.txt
...
echo "Notes: Runx1 in DP, great quality." >> $logdir/download_log_${des}.txt 
echo "-------------------------------------------------------------------------------------------------------------------------------------" >> $logdir/download_log_${des}.txt  
