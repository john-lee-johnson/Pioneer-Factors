...
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/B
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/CD4
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/CD8
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/CMP
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/Lsk
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/Mono
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/NK
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/B_Lsk
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/CD4_CD8
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/GN_Mono
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/NK_CD4_CD8
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/B_NK_CD4_CD8
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/B_CD4_CD8_Lsk_NK
#cp $dir0/Analysis/ATAC_seq/Union/R_output/B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed $dir0/Analysis/ATAC_seq/Union/R_output_Common/B_CD4_CD8_CMP_GMP_GN_Lsk_Mono_NK
...
#--------------------------Motif Analysis-------------------------------------------------
cd $dir0/Analysis/ATAC_seq/Union/R_output_Common/
for i in B CD4 CD8 CMP Lsk Mono NK B_Lsk CD4_CD8 GN_Mono NK_CD4_CD8 B_NK_CD4_CD8 B_CD4_CD8_Lsk_NK B_CD4_CD8_CMP_GMP_GN_Lsk_Mono_NK; do
cd $i
filename=$i
mergeBed -i B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2.bed > B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2_merge.bed
bedtools intersect -a B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2_merge.bed -b ${filename}.bed -wa > ${filename}_intersect.bed
mkdir -p ${filename}_Motif
bedtools subtract -A -a B_CD4_CD8_CMP_GMP_GN_Lsk_MEP_Mono_NK_union_log2_merge.bed -b ${filename}_intersect.bed | awk 'BEGIN{OFS="\t"} {print $1,$2,$3}' - > ${filename}_subtract_merge.bed
awk 'BEGIN {OFS="\t"} {print $1,$2,$3 "\tpeak" NR "\t0" "\t+"}' ${filename}_subtract_merge.bed > ${filename}_subtract_merge_5_column.bed ##Adds a unique peak name and strand info
awk 'BEGIN {OFS="\t"} {print $1,$2,$3 "\tpeak" NR "\t0" "\t+"}' ${filename}_intersect.bed > ${filename}_intersect_5_column_merge.bed
findMotifsGenome.pl ${filename}_intersect_5_column_merge.bed mm10 ${filename}_Motif -size given -p 35 -bg ${filename}_subtract_merge_5_column.bed	##Does motif analysis at unique ATAC seq peaks
cd $dir0/Analysis/ATAC_seq/Union/R_output_Common/
done
